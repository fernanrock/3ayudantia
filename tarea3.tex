...
\item Estado.
\item Estrategia.
\item Metodo Plantilla.
\item Visitante.

\end{itemize}

\section{APLICACIÓN EN ÁMBITOS CONCRETOS}

\begin{itemize}
\item Además de su aplicación directa en la construcción de software en general, 
y derivado precisamente del gran éxito que han tenido, los patrones de diseño han 
sido aplicados a múltiples ámbitos concretos produciéndose "lenguajes de patrones" y 
extensos "catálogos" de la mano de diversos autores.
\item Patrones de interfaz de usuario.
\item Patrones para la construcción de sistemas empresariales.
\item Patrones para la integración de sistemas.
\item Patrones de flujos de trabajo.
...
\begin{itemize}
\item https://github.com/fernanrock/3ayudantia/
\end{itemize}
